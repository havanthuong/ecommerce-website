            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    ...
                    <a href="index.php?user_profile=<?php echo $admin_id; ?>">
                        ...
                        <i class="fa fa-fw fa-user"></i> Information
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#p_cat">
                    ...
                    <i class="fa fa-fw fa-pencil"></i> Catagory
                ...
                <ul id="p_cat" class="collapse">
                    ...
                    <li>
                        <a href="index.php?insert_p_cat"> Insert Catagory </a>
                    </li>

                    <li>
                        <a href="index.php?view_p_cats"> View Catagory </a>
                    </li>
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#cat">
                    ...
                    <i class="fa fa-fw fa-arrows-v"></i> Catagory
                ...
                <ul id="cat" class="collapse">
                    ...
                    <li>
                        <a href="index.php?insert_cat"> Insert Catagory </a>
                    </li>

                    <li>
                        <a href="index.php?view_cats"> View Catagory </a>
                    </li>
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#contact_us">
                    ...
                    <i class="fa fa-fw fa-pencil"> </i> Contact
                ...
                <ul id="contact_us" class="collapse">
                    ...
                    <li>
                        ...
                        <a href="index.php?edit_contact_us"> Edit Contact</a>

                    </li>

                    <li>

                        <a href="index.php?insert_enquiry"> Insert Enquiry </a>
            ...
            <li>
                ...
                <a href="index.php?edit_about_us">
                    ...
                    <i class="fa fa-fw fa-edit"></i> Edit About Us
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#coupons">
                    ...
                    <i class="fa fa-fw fa-arrows-v"></i> Coupon
            ...
            <li>
                ...
                <a href="#" data-toggle="collapse" data-target="#terms">
                    ...
                    <i class="fa fa-fw fa-table"></i> Dashboard
                ...
                <ul id="terms" class="collapse">
                    ...
                    <li>
                        <a href="index.php?view_terms"> View Term </a>
                    </li>
            ...
            <li>
                ...
                <a href="index.php?view_payments">
                    ...
                    <i class="fa fa-fw fa-pencil"></i> View Term
            ...
            <li>
                ...
                <ul id="users" class="collapse">
                    ...
                    <li>
                        <a href="index.php?user_profile=<?php echo $admin_id; ?>"> Edit Information </a>
                    </li>
