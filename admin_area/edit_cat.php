    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                ...
                <i class="fa fa-dashboard"></i> Doashboard / Edit Catagory
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">
                    ...
                    <i class="fa fa-money fa-fw"></i> Edit Catagory
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label"> Catagory Title </label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label">Show as top catagory</label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-3 control-label"> Choose category image </label>
