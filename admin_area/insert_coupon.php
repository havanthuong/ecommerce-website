            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" action="">
                        ...
                        <div class="form-group">
                            <!-- form-group Starts -->
                            <label class="col-md-3 control-label">Choose a coupon for a Product or package</label>
                            <div class="col-md-6">
                                <select name="product_id" class="form-control">
                                    <option> Select product coupon </option>
                                    ...
                                    ?>
                                    <option></option>
                                    <option>Select coupon for package</option>
                                    <option></option>
