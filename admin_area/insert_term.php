  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <ol class="breadcrumb">
        <!-- breadcrumb Starts -->
        <li class="active">
          <i class="fa fa-dashboard"></i> Home Page / Insert Term
        </li>
      </ol><!-- breadcrumb Ends -->
    </div><!-- col-lg-12 Ends -->
  </div><!-- 1 row Ends -->
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" action="" method="post">
            ...
            <div class="form-group">
              <!-- form-group Starts -->
              <label class="col-md-3 control-label"> Insert Title </label>
              <div class="col-md-6">
                <!-- col-md-6 Starts -->
            ...
            <div class="form-group">
              <!-- form-group Starts -->
              <label class="col-md-3 control-label"> Term and Conditions </label>
              <div class="col-md-6">
                <!-- col-md-6 Starts -->
