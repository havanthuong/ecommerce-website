          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <p style="font-size:15px; font-weight:bold;">
                    ...
                    Example for Bundle: navy-blue-t-shirt
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Choose a manufacturer </label>
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Image Bundle 1 </label>
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Image Bundle 2 </label>
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Image Bundle 3 </label>
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Group keyword </label>
              ...
              <div class="form-group">
                ...
                <label class="col-md-3 control-label"> Tab Group </label>
                ...
                <div class="col-md-6">
                  ...
                  <ul class="nav nav-tabs">
                    ...
                    <li>
                      ...
                      <a data-toggle="tab" href="#video"> Sound and Video </a>
