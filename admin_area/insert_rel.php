...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            <!-- breadcrumb Starts -->
            <li class="active">
                <i class="fa fa-dashboard"></i> Dashboard / Insert Relationship
            </li>
        </ol><!-- breadcrumb Ends -->
    </div><!-- col-lg-12 Ends -->
</div><!-- 1 row Ends -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">
                    <!-- panel-title Starts -->
                    <i class="fa fa-money fa-fw"></i> Insert Relationship
                </h3><!-- panel-title Ends -->
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                        <!-- form-group Starts -->
                        <label class="col-md-3 control-label">Relationship Title</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <!-- form-group Starts -->
                        <label class="col-md-3 control-label"> Choose Product </label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <!-- form-group Starts -->
                        <label class="col-md-3 control-label"> Choose Package </label>
                        <div class="col-md-6">
